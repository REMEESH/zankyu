...
function Footer() {
    return (
        <div style={{ width: '100%', height: '350px' }}  className='d-flex bg-success flex-column justify-content-center align-items-center'>
            <div className="footer-div d-flex justify-content-evenly flex-wrap w-100">
                <div className="website" style={{ width: '400px' }}>
                    <h4 className='text-white'><i className="fa-brands fa-stack-overflow"></i>Project Fair</h4>
                ...
                <div className="content">
                    ...
                    <div className="sub d-flex" >
                        ...
                        <button className='btn btn-light ms-4'><i className="fa-solid fa-arrow-right-long"></i></button>
                    </div>
